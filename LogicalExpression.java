		...
		public void setUniqueSymbol( String newSymbol ) 
			...
			if( this.uniqueSymbol != null ) 
                  ...
                  else if( valid ) 
                  {
					...
					boolean contains;
					contains = CheckTrueFalse.symbolstable.containsKey(newSymbol);
					if (! contains)
					{
						CheckTrueFalse.symbolstable.put(newSymbol, 2);
						CheckTrueFalse.hash[i++][0] = newSymbol;
						CheckTrueFalse.hash[i - 1][1] = Integer.toString(i-1);
					}
			} 
		}
